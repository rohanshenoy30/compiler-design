...
static const short yyprhs[] = {     0,
     0,     4,     8,    10,    12,    14,    18,    20,    29,    34,
    38,    40,    42
};

static const short yyrhs[] = {     3,
    14,     6,     0,    15,     7,    14,     0,    15,     0,    16,
     0,    17,     0,     4,     8,    19,     0,     4,     0,     4,
     9,     5,    10,     8,    11,    18,    12,     0,     4,     9,
     5,    10,     0,    19,     7,    18,     0,    19,     0,     4,
     0,     5,     0
};
...
static const short yyrline[] = { 0,
    12,    15,    16,    18,    19,    22,    23,    25,    26,    28,
    29,    31,    32
};

static const char * const yytname[] = {   "$","error","$illegal.","TYPE","ID",
"NUMBER","';'","','","'='","'['","']'","'{'","'}'","stmt","declist","dec","vardec",
"arrdec","vallist","val",""
};
#endif
...
static const short yypact[] = {     1,
     2,    -8,    -1,     0,-32768,-32768,    -2,     3,-32768,     2,
-32768,-32768,-32768,     4,-32768,     5,     6,    -2,    -3,     8,
-32768,    -2,-32768,    10,    11,-32768
};

static const short yypgoto[] = {-32768,
     9,-32768,-32768,-32768,   -10,    13
};
...
static const short yytable[] = {     7,
     8,    11,    12,     1,     9,     2,    10,    14,    21,    25,
    26,    23,    17,    16,    22,     0,    18,     0,    15,    13
};

static const short yycheck[] = {     8,
     9,     4,     5,     3,     6,     4,     7,     5,    12,     0,
     0,    22,     8,    10,     7,    -1,    11,    -1,    10,     7
};
