...
const int YY_parse_CLASS::REL=262;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 263 ? yytranslate[x] : 22)
...
static const short yyprhs[] = {     0,
     0,     3,     8,    10,    19,    24,    25,    28,    29,    33,
    35
};

static const short yyrhs[] = {    17,
     8,     0,     5,     9,    21,    10,     0,    17,     0,     3,
    11,    20,    12,    13,    19,    14,    18,     0,     4,    13,
    19,    14,     0,     0,    16,    19,     0,     0,    21,     7,
    21,     0,     5,     0,     6,     0
};
...
static const short yyrline[] = { 0,
    14,    16,    17,    20,    23,    24,    27,    28,    31,    34,
    35
};

static const char * const yytname[] = {   "$","error","$illegal.","IF","ELSE",
"ID","NUMBER","REL","NL","'='","';'","'('","')'","'{'","'}'","start","stmt",
"ifstmt","elsestmt","stmtlist","exp","val",""
};
#endif

static const short yyr1[] = {     0,
    15,    16,    16,    17,    18,    18,    19,    19,    20,    21,
    21
};
...
static const short yypact[] = {     4,
    -8,     1,     0,-32768,-32768,-32768,     2,     5,    -2,     0,
    -1,-32768,     6,    -1,-32768,     3,     0,-32768,     9,     8,
     7,-32768,-32768,    -1,    10,-32768,    16,    19,-32768
};

static const short yypgoto[] = {-32768,
-32768,    21,-32768,   -14,-32768,    -9
};
...
static const short yytable[] = {    18,
    12,     1,     3,    13,     5,     6,     1,    20,     4,    25,
    11,    10,    21,     9,    17,    28,    19,    23,    29,    24,
     2,     0,     0,    26
};

static const short yycheck[] = {    14,
    10,     3,    11,     5,     5,     6,     3,    17,     8,    24,
    13,     7,     4,    12,     9,     0,    14,    10,     0,    13,
     0,    -1,    -1,    14
};
